                        ...
                        <div class="mb-4">
                            ...
                            <div id="reopenMpesaPrompt" class="alert alert-success d-none align-items-center justify-content-between mt-3 mb-0">
                                <div>
                                    ...
                                    Mpesa selected — an STK push is needed to confirm this payment.
                                </div>
                            ...
                            <div id="mpesaConfirmedBanner" class="alert alert-success d-none mt-3 mb-0">
                                ...
                                Mpesa payment confirmed. Receipt: <strong id="mpesaConfirmedReceipt"></strong>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted small mb-3">
                    ...
                    A payment prompt will be sent to the phone number below. Ask the payee to enter their Mpesa PIN to complete the transaction.
                </p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="modal_sendStkPush" onclick="initiateMpesaPayment()">
                    <i class="fas fa-paper-plane me-1"></i> Send STK Push
                </button>
            </div>
        </div>
...
<script>
    // ⭐ FIX #4: Clean up polling on page unload
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // ⭐ FIX #2: Configure Axios with CSRF token
        ...
        function syncModalFields() {
            ...
            if (studentNameElement) {
                ...
                console.log('📝 Setting student name to:', name);
        ...
        if (modalElement) {
            modalElement.addEventListener('show.bs.modal', function() {
                console.log('🔔 Modal opening, syncing fields...');
                syncModalFields();
            });
        }
        ...
        // ============================================
        // ⭐ FIX #1: Form submission guard with isSubmitting flag
        // ============================================
    ...
    // ============================================
    // ⭐ FIX #3: Strict phone number validation
    // ============================================
    function validateMpesaNumber() {
        ...
        // If starts with 0 (e.g., 07XXXXXXXX), convert to 2547XXXXXXXX
        ...
        // Final validation: must be 2547XXXXXXXX (12 digits total)
    ...
    // ============================================
    // ⭐ FIX #6: Better amount validation
    // ============================================
    ...
    // ============================================
    // ⭐ FIX #10: Validate student selection
    // ============================================
    ...
    // ============================================
    // ⭐ FIX #7 & #9: Initiate M-Pesa STK Push with redirect
    // ============================================
    async function initiateMpesaPayment() {
        ...
        // ⭐ FIX #7: Disable button and show loading state
        ...
        try {
            // ⭐ FIX #8: Use the correct route name - mpesa.stkpush (not mpesa.stkpush.fee)
    ...
    // ============================================
    // ⭐ FIX #8: Poll for transaction status with correct route
    // ============================================
    function startPolling(checkoutRequestId) {
        ...
        pollingInterval = setInterval(async () => {
            ...
            try {
                // ⭐ FIX #8: Use mpesa.status (not mpesa.status.fee)
                ...
                if (response.data.success && response.data.resultCode === '0') {
                    ...
                    // ⭐ FIX #5: Safe receipt number assignment
                    ...
                    // ⭐ FIX #9: Redirect to receipt after successful payment
                    setTimeout(() => {
                        ...
                        // ⭐ FIX #1: Submit form with isSubmitting flag
                        const form = document.getElementById('paymentForm');
                        if (!isSubmitting) {
                            isSubmitting = true;
                            form.submit();
                ...
                if (response.data.success === false && response.data.resultCode) {
                    ...
                    const resultCodes = {
                        '1032': 'The Mpesa payment request was cancelled by the user.',
                        '1037': 'The Mpesa payment request timed out.',
                ...
                if (attempts >= maxAttempts) {
                    ...
                    Swal.fire({
                        ...
                        text: 'We are still waiting for confirmation. You can check Mpesa messages for the transaction.',
                        confirmButtonColor: '#6c8cff'
                    });
                }
            } catch (error) {
